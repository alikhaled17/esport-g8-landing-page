...
let Data = {
  ...
  ar: {
    ...
    esportIntroduction: [
      "مجموع جوائز بقيمة 15 مليون دولار بيتنافس عليها أكبر الفِرق في العالم بموسم الجيمرز هذا الصيف في الرياض. كل بطولة بتكون تجربة من الخيال وبيشارك فيها نخبة الرياضيين في عالم الرياضات الإلكترونية في العالم.",
